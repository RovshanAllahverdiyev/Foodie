import FoodImg1 from "../../assets/biryani3.png";
import FoodImg2 from "../../assets/biryani5.png";
import FoodImg3 from "../../assets/biryani2.png";
...
const Hero = () => {
  const [imageId, setImageId ] = useState(FoodImg1)
              ...
              <div className="h-[300px] sm:h-[450px] overflow-hidden flex justify-center items-center">
                <img
                 ...
                 data-aos-once='true'
                  src={imageId}
                  alt="food img"
                  className="w-[300px] sm:w-[450px] sm:scale-125 spin  mx-auto  "
                />
              </div>
